...
export default function Nav() {
   ...
   return (
      <nav className="relative flex justify-between items-center p-4">
         ...
         <div
            className={`lg:hidden fixed inset-0 bg-black bg-opacity-50 z-10 transition-all transform ${
         ...
         {/* Sidebar for mobile */}
         <div
            className={`lg:hidden fixed left-0 top-0 w-3/4 h-full bg-white z-20 transition-all transform ${
               isOpen ? 'translate-x-0' : '-translate-x-full'
            }`}
         >
            {/* Close button */}
